---
layout: post
title:  "Daily Update 5/20/19"
date:   2019-05-20 08:30:00 -0500
...
Today I'll be tackling the following items:
 - Intermediate Java koans.
 - Understanding more about my bash profile so I can help some other apprentices set their's up as well as improve the customization of my own.
    - I found some good resources to start:
...
{% endhighlight %}
 ...
 - Exercsm - Two Fer - I received feedback that I could boil the below code down to one return statement, which makes sense to me.
{% highlight java %}
class Twofer {
